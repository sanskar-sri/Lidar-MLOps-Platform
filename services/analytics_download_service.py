...
def download_silver_analytics(dataset_id: str, prep_version: str, run_id: str, bucket: str) -> dict:
    ...
    prefix  = f"{b2_prefix('silver_preprocessed_data')}/{dataset_id}/{prep_version}/silver/"
...
def download_gold_analytics(dataset_id: str, prep_version: str, run_id: str, bucket: str) -> dict:
    ...
    downloaded, errors = [], []
    for sub, prefix in [
        ("eval", f"{b2_prefix('gold_model_ready_data')}/{dataset_id}/{prep_version}/eval/"),
        ("meta", f"{b2_prefix('gold_model_ready_data')}/{dataset_id}/{prep_version}/meta/"),
    ]:
